...
from .serializers import FundraiserSerializer, PledgeSerializer #telling Django "from the serializer.py file, import and read the FundraiserSerializer class"
...
class FundraiserDetail(APIView): #inheriting the APIView
    def get(self, request, pk):
        ...
        serializer = FundraiserSerializer(fundraiser) #running the fundraising variable and serializing the result - store the result in serializer variable
